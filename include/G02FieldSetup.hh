...
// ********************************************************************
//
/// \file field/field01/include/G02FieldSetup.hh
/// \brief Definition of the G02FieldSetup class
//
//
//
//
...
#ifndef G02FieldSetup_h
#define G02FieldSetup_h 1
...
{
public:
  G02FieldSetup(G4ThreeVector,                //  The value of the field
                G4int  stepperNum = -1000,    //  -ive = fsal, +ive = old.
                                              // default (-1000) uses next flag
                G4bool useFSALstepper= false );

  G02FieldSetup();               //  A zero field
  G02FieldSetup( G02FieldSetup & ) = delete;

  virtual ~G02FieldSetup();
