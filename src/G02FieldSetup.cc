...
// ********************************************************************
//
/// \file field/field01/src/G02FieldSetup.cc
/// \brief Implementation of the G02FieldSetup class
//
//
//
...
G02FieldSetup::G02FieldSetup(G4ThreeVector fieldVector,
                             G4int         stepperNum,
 ...
 : fMagneticField(new G4UniformMagField(fieldVector)),
   ...
   fMinStep(0.)
{
  G4cout << " G02FieldSetup: magnetic field set to Uniform( "
         << fieldVector << " ) " << G4endl;
...
G02FieldSetup::G02FieldSetup()
 : fMagneticField(new G4UniformMagField(G4ThreeVector())),
   fUseFSALstepper(false),
   fStepperType(17),   // Use Dormand Prince (7) 4/5 as default stepper
   fMinStep(0.)
{
  G4cout << " G02FieldSetup: magnetic field set to Uniform( 0.0, 0, 0 ) "
         << G4endl;
  InitialiseAll();
}
...
void G02FieldSetup::InitialiseAll()
{
...
void G02FieldSetup::CreateStepperAndChordFinder()
{
  delete fChordFinder;
  fChordFinder = nullptr;

  // Update field
  G4cout << " G02FieldSetup::CreateStepperAndChordFinder() called. " << G4endl
...
G02FieldSetup::CreateFSALStepperAndDriver()
{
   // using FsalStepperType = G4RK547FEq1;
  const char *methodName= "G02FieldSetup::CreateFSALStepperAndDriver()";
  if (fStepper) delete fStepper;
  fStepper = nullptr;

  G4cout << " G02FieldSetup::CreateFSALStepperAndDriver() called. " << G4endl;
...
void G02FieldSetup::CreateFSALStepperAndChordFinder()
{
  // using FsalStepperType = G4DormandPrince745; // eventually ?
  delete fChordFinder;
  fChordFinder= nullptr;

  G4cout << " G02FieldSetup::CreateFSALStepperAndChordFinder() called. " << G4endl;
...
void G02FieldSetup::SetFieldZValue(G4double fieldStrength)
{
...
void G02FieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
G4FieldManager* G02FieldSetup::GetGlobalFieldManager()
{
  //  Utility method
